...
2. Be serialized/retained as TranslatedString objects or raw strings in JSON output, based on input
"""
...
class TestCauseEffectDetailJsonOutput:
    """Test that cause_detail and effect_detail retain their original format in JSON output."""
    ...
    def test_json_output_preserves_translated_string_cause_detail(
        self, feed_with_cause_effect_detail_translated_string_json: dict[str, Any]
    ) -> None:
        """cause_detail should be a TranslatedString in JSON output, not a raw string."""
    ...
    def test_json_output_preserves_translated_string_effect_detail(
        self, feed_with_cause_effect_detail_translated_string_json: dict[str, Any]
    ) -> None:
        """effect_detail should be a TranslatedString in JSON output, not a raw string."""
        source_json = feed_with_cause_effect_detail_translated_string_json
        content = json.dumps(source_json).encode("utf-8")
    ...
    def test_enhanced_json_output_preserves_translated_strings(
        self, feed_with_cause_effect_detail_translated_string_json: dict[str, Any]
    ) -> None:
        """Both fields should remain TranslatedStrings in enhanced JSON output too."""
        source_json = feed_with_cause_effect_detail_translated_string_json
        content = json.dumps(source_json).encode("utf-8")
